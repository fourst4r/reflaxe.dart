...
function main() {
    ...
    // unit.HelperMacros.typedAs((null : Map<String, Int>), map = []); (4*): uncomment this later
    // assert(unit.HelperMacros.typeError(map[1] = 1) == true);        (4*): uncomment this later
